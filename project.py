...
from flask import (Flask, render_template, request, redirect, make_response, url_for, flash, jsonify)
...
def catalog():
    ...
    return render_template('catalog.html', categories=categories, latest_items=latest_items, is_logged_in=is_already_logged_in(login_session))
...
def show_items_in_category(category_id):
    ...
    return render_template('category.html', category=category, items=items, is_logged_in=is_already_logged_in(login_session))
...
def show_item(category_id, item_id):
    ...
    return render_template('item.html', category=category, item=item, is_logged_in=is_already_logged_in(login_session), is_logged_in_owner=is_logged_in_as_owner(login_session, item.user_id))
